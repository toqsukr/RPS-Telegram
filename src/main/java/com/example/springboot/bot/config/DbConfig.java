package com.example.springboot.bot.config;
...
public class DbConfig extends DefaultDbConfig {
    ...
    public static class SpringDataJdbcProperties {
         ...
         * sit idle in the pool. A value of 0 means that idle connections are never
         ...
         * a connection
         * reaches this timeout, even if recently used, it will be retired from the
         * pool.
         * An in-use connection will never be retired, only when it is idle will it be
         * removed
         */
        long maxLifetime;
        /**
